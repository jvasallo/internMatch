...
class CompanyRegistrationForm(forms.Form):
    ...
    description = forms.CharField(label=(u'Company Description'), required=False)
    ...
    username = forms.CharField(label=(u'User Name'), required=True)
    email = forms.EmailField(label=(u'Email Address'), required=True)
    phone = forms.CharField(label=(u'Contact Phone Number'), required=True)
    contactEmail = forms.EmailField(label=(u'Contact Email Address'), required=True)
